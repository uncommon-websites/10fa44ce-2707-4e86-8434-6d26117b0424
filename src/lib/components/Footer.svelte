<footer class="bg-white pt-20 pb-10">
    <!-- CTA Section -->
    <div class="container mx-auto px-4 max-w-7xl mb-24">
        <div class="grid grid-cols-1 lg:grid-cols-2 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <!-- Right Content -->
            <div class="bg-black text-white p-10 md:p-16 flex flex-col justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center gap-2 mb-6">
                    <div class="w-8 h-8 text-gray-900">
                        <svg viewBox="0 0 111 132" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
                 <div class="mb-8">
                    <h4 class="font-bold text-gray-900 mb-4 text-sm">Company</h4>
                    <ul class="space-y-2 text-sm text-gray-500">
